...
import com.pivovarit.rental.exception.CannotReturnException;
import com.pivovarit.rental.exception.ConcurrentLogWriteException;
import com.pivovarit.rental.exception.MovieAlreadyRentedException;
import com.pivovarit.rental.exception.MovieNotExistsException;
import com.pivovarit.rental.exception.UserCannotRentException;
import com.pivovarit.rental.model.Movie;
import com.pivovarit.rental.model.MovieId;
import com.pivovarit.rental.model.UserRentals;
...
public class MovieRentalService {
    ...
    public MovieRentalService(InMemoryRentalHistory rentalHistoryRepository, InMemoryMovieRepository movieRepository) {
